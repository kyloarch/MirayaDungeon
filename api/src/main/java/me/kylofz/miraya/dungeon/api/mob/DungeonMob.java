 ...
 */
package me.kylofz.miraya.dungeon.api.mob;
...
public interface DungeonMob {
     ...
     * <p>
     * This includes the {@link #getTypeMobSet() type set} and the {@link me.kylofz.miraya.dungeon.api.world.GameWorld#getAllMobSet() generic set}.
     *
     ...
     * @throws IllegalArgumentException if the mob set is not registered in the {@link me.kylofz.miraya.dungeon.api.world.GameWorld}
