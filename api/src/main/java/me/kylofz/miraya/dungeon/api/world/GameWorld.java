 ...
 */
package me.kylofz.miraya.dungeon.api.world;
 ...
 * <p>
 * A game world is not equal to a {@link me.kylofz.miraya.dungeon.api.dungeon.Dungeon}.
 *
...
public interface GameWorld extends InstanceWorld {
     ...
     * @see me.kylofz.miraya.dungeon.api.trigger.TriggerTypeKey
    ...
    /**
     * Returns the start location of the world. This may be set by a start {@link me.kylofz.miraya.dungeon.api.sign.DungeonSign sign} or, if none exists, the
